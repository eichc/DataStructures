...
int main() {
  ...
  cout << endl << "Testing remove_matching_elements:" << endl;
  
  Vec<int> test1 = v1;
  cout << "Contents of test1: " << endl;
  test1.print();

  remove_matching_elements(test1, 100);
  cout << "After removing 100, test1 is now:" << endl;
  test1.print();
  
  remove_matching_elements(test1, 20);
  cout << "After removing 20, test1 is now:" << endl;
  test1.print();

  cout << endl << "Testing bulk push_back, printing every 10 iterations: " << endl;
