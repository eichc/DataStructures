...
int main() {
  ...
  std::cout << "testing IsEarlierThan" << std::endl;
  bool early1 = IsEarlierThan(a, b);
  bool early2 = IsEarlierThan(a, c);
  bool early3 = IsEarlierThan(midnight, midnight2);
  std::cout << early1 << std::endl;
  std::cout << early2 << std::endl;
  std::cout << early3 << std::endl;
