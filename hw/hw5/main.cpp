...
void StudentTests() {
  ...
  std::cout << std::endl << "Testing infinite distance to dining" << std::endl;
  TrainCar* test1 = NULL;
  PushBack(test1, TrainCar::MakeEngine()); 
  PushBack(test1, TrainCar::MakePassengerCar());
  PushBack(test1, TrainCar::MakePassengerCar());
  PushBack(test1, TrainCar::MakeFreightCar(50));
  PushBack(test1, TrainCar::MakeDiningCar());
  PushBack(test1, TrainCar::MakePassengerCar());
  PushBack(test1, TrainCar::MakeSleepingCar());

  SanityCheck(test1);
  PrintTrain(test1);
  DeleteAllCars(test1);

  std::cout << std::endl << "Testing infinite engine to sleeper" << std::endl;
  TrainCar* test2 = NULL;
  PushBack(test2, TrainCar::MakeEngine()); 
  PushBack(test2, TrainCar::MakePassengerCar());
  PushBack(test2, TrainCar::MakeDiningCar());
  PushBack(test2, TrainCar::MakePassengerCar());
  ...
  std::cout << std::endl << "Testing closest engine to sleeper" << std::endl;

  TrainCar* test3 = NULL;
  PushBack(test3, TrainCar::MakeEngine()); 
  PushBack(test3, TrainCar::MakePassengerCar());
  PushBack(test3, TrainCar::MakePassengerCar());
  PushBack(test3, TrainCar::MakeSleepingCar());
  PushBack(test3, TrainCar::MakeDiningCar());
  PushBack(test3, TrainCar::MakePassengerCar());
  PushBack(test3, TrainCar::MakeSleepingCar());
  PushBack(test3, TrainCar::MakeEngine());
  ...
  std::cout << std::endl << "Testing ship freight with 0 freight" << std::endl;
  MTRand_int32 mtrand_fixed_seed(42);
  ShipFreightHelper(mtrand_fixed_seed,10,0,60,12);

  std::cout << std::endl << "Testing ship freight with 0 engines" << std::endl;
  ShipFreightHelper(mtrand_fixed_seed,0,10,60,12);

  std::cout << std::endl << "Testing separate with more than 2 engines" << std::endl;
  ...
  PushBack(t, TrainCar::MakeDiningCar());
  PushBack(t, TrainCar::MakePassengerCar());
  SeparateTestHelper(t, "(3 ENGINES)");
